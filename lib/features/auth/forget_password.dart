      ...
      body: Form(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                  height: isLargeScreen ? size.height * 0.2 : size.width * 0.2),
              const BoldHeaderText(label: "Change Password"),
              SizedBox(
                  height: isLargeScreen ? size.height * 0.1 : size.width * 0.1),
              SizedBox(
              ...
              Align(
                alignment:
                    isLargeScreen ? Alignment.center : Alignment.centerRight,
                child: TextButton(
                  onPressed: () {},
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: SmallButton(
                    radius: 10,
                    fontSize: 16,
                    label: showMoreFields ? "Change Password" : "Send",
                    onPressed: showMoreFields
                        ...
                        : () async {
                            if (email != null) {
                              ...
                              showNotification(title: "Email is required");
                            }
                          },
                  ),
                ),
